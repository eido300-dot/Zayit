...
class PortableSettingsStore private constructor(
    ...
    companion object {
        ...
        fun open(
            ...
            val initial =
                when (result) {
                    is LoadResult.Loaded -> result.properties
                    // A readable older copy beats empty settings, which would show onboarding again.
                    is LoadResult.IoError -> result.fallback ?: Properties()
